...
public class EventListenerTest extends BaseTest {
	 ...
	 * 
	 * 
	 * @Test public void expiredEventTest() {
	 * 
	 ...
	 * 
	 * @Override public void onExpired(String s) { // TODO Auto-generated method
	 * stub System.out.println("Expired : " + s); } }).then();
	 * 
	 ...
	 * }
	 * 
	 * @Test public void deletedEventTest() {
	 * 
	 * RBucketReactive<String> bucket = this.client.getBucket("user:1:name",
	 * StringCodec.INSTANCE); Mono<Void> set = bucket.set("joffre"); Mono<Void> get
	 * = bucket.get().doOnNext(System.out::println).then();
	 * 
	 * Mono<Void> event = bucket.addListener(new DeletedObjectListener() {
	 * 
	 * @Override public void onDeleted(String s) { System.out.println("Deleted : " +
	 * s);
	 * 
	 * } }).then();
	 * 
